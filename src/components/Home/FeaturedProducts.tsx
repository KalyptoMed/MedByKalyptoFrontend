      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#004D4A] dark:text-white">Featured Products</h2>
            <p className="text-gray-500 dark:text-gray-400 mt-2">Top-rated medications at unbeatable prices</p>
          </div>
          <Link
            href="/products/all"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="bg-white dark:bg-gray-900 rounded-3xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 group"
            >
              <div className="relative bg-[#EBFFF5] dark:bg-gray-800 h-52 flex items-center justify-center overflow-hidden">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white dark:bg-gray-700 shadow-card flex items-center justify-center z-10 hover:scale-110 transition-transform"
                >
                  <Heart
                    size={16}
